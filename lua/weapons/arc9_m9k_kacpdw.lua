...
SWEP.ViewModel = "models/weapons/arc9_m9k_kacpdw.mdl"
...
SWEP.ShootSound = "weapons/kacpdw/m4a1_unsil-1.wav"                         -- Fire

SWEP.ShootSoundSilenced = "weapons/kacpdw/m4a1-1.wav"                    -- Fire silenced
...
SWEP.Attachments = {
    ...
    {
        PrintName = "Sticker A",
        StickerModel = "models/stickers/arc9_m9k_stickersa_kacpdw.mdl",
        Category = "stickers",
        Bone = "weapon",
        Pos = Vector(0, 0, 0),
    },
...
SWEP.Animations = {
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            {s = "weapons/kacpdw/m4a1_clipout.mp3", t = 0.43},
            {s = "weapons/kacpdw/m4a1_clipin.mp3", t = 1.56},
            {s = "weapons/kacpdw/boltrel.wav", t = 2.13},
            {hide = 1, t = 0.43},
            {hide = 0, t = 1.1},
        }
    },
