...
SWEP.Description = [[The Mossberg 590 shotgun was introduced in 1987 (the same year as the Mossberg Mariner).
 The Mossberg 590 shotguns differ from the 500 series primarily because of the design of the cap for the shell tube. 
 The 500 series shotguns are designed for easy swapping of barrels. The 590 magazine tube is designed for ease of cleaning and maintenance. 
The 'nub' at the end of the 590's magazine tube was originally designed for holding the ring of the M7/M9 Bayonet when the bayonet is attached to the lug underneath the barrel. Other versions of the 590 maintain this style of end cap, even those without bayonet lugs.]]


SWEP.UseHands = true -- Same as weapon_base

SWEP.ViewModel = "models/weapons/arc9_m9k_mossberg590.mdl"
...
SWEP.WorldModelOffset = {
     Pos = Vector(-9,5.5, -5), -- non tpik (while on ground, on npc etc)
     Ang = Angle(0, 0, 180),
     TPIKPos = Vector(-9,5.5, -5), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.ShootSound = "weapons/m590/m3-1.wav"                            -- Fire
...
SWEP.ActivePos = Vector(-0.5, -6, 0.1)
...
SWEP.Animations = {
    ...
    ["cycle"] = {
        ...
        EjectAt = 0.28  ,
        EventTable = {
            {s = "weapons/m590/pumpback.wav", t = 0.14},
            {s = "weapons/m590/pumpfwd.wav", t = 0.35},
            {hide = 1 , t = 0},
        }
    },
    ["cycle_iron"] = {
    ...
    ["reload_insert"] = {
        Source = "reload_loop",
        EventTable = {
            {s = "weapons/m590/m3_insertshell.mp3", t = 0.13},
    ...
    ["reload_finish_empty"] = {
        ...
        EventTable = {
            ...
            {s = "weapons/m590/pumpback.wav", t = 0.23},
            {s = "weapons/m590/pumpfwd.wav", t = 0.43},
            {hide = 1 , t = 0},
        }
    },
    ["draw"] = {
