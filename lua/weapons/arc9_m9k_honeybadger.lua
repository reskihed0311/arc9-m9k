...
SWEP.WorldModelOffset = {
     Pos = Vector(-9, 5, -3), -- non tpik (while on ground, on npc etc)
     Ang = Angle(0, 0, 180),
     TPIKPos = Vector(-9, 5, -3), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.MuzzleParticle = "muzzleflash_suppresed" -- Used for some muzzle effects.
...
SWEP.Attachments = {
    ...
    {
        PrintName = "Sticker A",
        StickerModel = "models/stickers/arc9_m9k_stickersa_honey.mdl",
        Category = "stickers",
        Bone = "weapon",
        Pos = Vector(0, 0, 0),
    },
