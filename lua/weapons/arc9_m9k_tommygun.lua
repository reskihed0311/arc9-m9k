...
SWEP.Description = [[The Thompson, popularly nicknamed the "Tommy Gun", is an American submachine gun that was designed by John Talliaferro Thompson and produced by the Auto-Ordnance Corporation. ]]


SWEP.UseHands = true -- Same as weapon_base

SWEP.ViewModel = "models/weapons/arc9_m9k_tommygun.mdl"
...
SWEP.WorldModelOffset = {
     Pos = Vector(-10.9, 4, -3), -- non tpik (while on ground, on npc etc)
     Ang = Angle(0, 0, 180),
     TPIKPos = Vector(-10.9, 5, -3), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.ShootSound = "weapons/tommygun/tmg_1.wav"                         -- Fire
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
            {s = "weapons/tommygun/tmg_magout.mp3", t = 0.30},
            {s = "weapons/tommygun/tmg_magin.mp3", t = 1.70},
            {hide = 1, t = 0.8},
            {hide = 0, t = 1.35},
        }
    },
    ["reload_empty"] = {
        ...
        EventTable = {
            {s = "weapons/tommygun/tmg_magout.mp3", t = 0.30},
            {s = "weapons/tommygun/tmg_magin.mp3", t = 1.70},
            {s = "weapons/tommygun/tmg_cock.mp3", t = 2.53},
            {hide = 1, t = 0.8},
            {hide = 0, t = 1.35},
        }
    },
