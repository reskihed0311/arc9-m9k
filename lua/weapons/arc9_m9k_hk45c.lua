...
SWEP.Description = [[The HK45 was designed to meet requirements set forth in the U.S. Military Joint Combat Pistol program which had the purpose of arming the U.S. Military with a .45 ACP semi-automatic pistol instead of the 9mm M9 pistol.]]


SWEP.UseHands = true -- Same as weapon_base

SWEP.ViewModel = "models/weapons/arc9_m9k_hk45.mdl"
...
SWEP.DropMagazineModel = "models/mags/m9k_mag_hk45.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.DropMagazinePos = Vector(0, -5, -2) -- offsets
...
SWEP.ShootSound = "weapons/hk45/hk45-1.wav"                            -- Fire
...
SWEP.Animations = {
    ...
    ["reload"] = {
        Source = "reload",
        DropMagAt = 0.5, -- Drop magazine at this time
        EventTable = {
            {s = "weapons/hk45/magout.mp3", t = 0.30},
            {s = "weapons/hk45/magin.mp3", t = 1.05},
            {hide = 1, t = 0.20},
            {hide = 0, t = 1},
        }
    },
    ["reload_empty"] = {
        ...
        EventTable = {
            {s = "weapons/hk45/magout.mp3", t = 0.30},
            {s = "weapons/hk45/magin.mp3", t = 1.05},
            {s = "weapons/hk45/sliderelease.mp3", t = 1.55},
            {hide = 1, t = 0.20},
            {hide = 0, t = 1},
        }
    },
