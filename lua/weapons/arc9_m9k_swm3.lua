...
SWEP.Description = [[The Smith & Wesson Model 3 is a single-action, cartridge-firing, 
top-break revolver produced by Smith & Wesson (S&W) from around 1870 to 1915, and was recently again offered as a reproduction by Smith & Wesson and Uberti.]]


SWEP.UseHands = true -- Same as weapon_base

SWEP.ViewModel = "models/weapons/arc9_m9k_swmodel3.mdl"
...
SWEP.WorldModelOffset = {
     Pos = Vector(-16, 5, 1), -- non tpik (while on ground, on npc etc)
     Ang = Angle(0, 0, 180),
     TPIKPos = Vector(-16, 2, -2), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.ShootSound = "weapons/model3/model3-1.wav"                            -- Fire

SWEP.ShootSoundSilenced = nil                  -- Fire silenced
...
SWEP.HideBones = {"bullet_1","bullet_2","bullet_3","bullet_4","bullet_5","bullet_6","speedloader"} -- bones to hide in third person and customize menu. {"list", "of", "bones"}
...
SWEP.Attachments = {
    ...
    {
        PrintName = "Sticker A",
        StickerModel = "models/stickers/arc9_m9k_stickersa_swrussian.mdl",
        Category = "stickers",
        Bone = "weapon",
        Pos = Vector(0, 0, 0),
    },
...
local bullets = {"weapons/model3/bulletout_1.mp3", "weapons/model3/bulletout_2.mp3", "weapons/model3/bulletout_3.mp3"}
...
SWEP.Animations = {
     ...
     ["trigger"] = {
        Source = "trigger",
        EventTable = {
            {s = "weapons/model3/hammer.mp3", t = 0}
        }
    },
    ["fire"] = {
        Source = "fire",
    ...
    ["reload"] = {
        ...
        EventTable = {
            {s = "weapons/model3/break_open.wav", t = 0.25},
            {s = bullets, t = 1},
            {s = "weapons/model3/bullets_in.mp3", t = 1.4},
            {s = "weapons/model3/break_close.mp3", t = 2.05},
        }
    },
    ["draw"] = {
        Source = "draw",
