...
SWEP.ViewModel = "models/weapons/arc9_m9k_1897trench.mdl"
...
SWEP.WorldModelOffset = {
     Pos = Vector(-8,5, -5), -- non tpik (while on ground, on npc etc)
     Ang = Angle(0, 0, 180),
     TPIKPos = Vector(-8,5, -5), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.ShootSound = "weapons/1897/fire.wav"                            -- Fire
...
SWEP.Attachments = {
    ...
    {
        PrintName = "Sticker A",
        StickerModel = "models/stickers/arc9_m9k_stickersa_1897.mdl",
        Category = "stickers",
        Bone = "weapon",
        Pos = Vector(0, 0, 0),
    },
...
SWEP.Animations = {
    ...
    ["cycle"] = {
        ...
        EjectAt = 0.31  ,
        EventTable = {
            {s = "weapons/1897/pumpback.wav", t = 0.05},
            {s = "weapons/1897/pumpforward.wav", t = 0.33},
            {hide = 1 , t = 0},
        }
    },
    ["cycle_iron"] = {
    ...
    ["reload_insert"] = {
        Source = "reload_loop",
        EventTable = {
            {s = "weapons/1897/m3_insertshell.mp3", t = 0.25},
   ...
   {s = "weapons/1897/pumpback.wav", t = 0.28},
            {s = "weapons/1897/pumpforward.wav", t = 0.59},
            {hide = 1 , t = 0},
        }
    },
    ["draw"] = {
