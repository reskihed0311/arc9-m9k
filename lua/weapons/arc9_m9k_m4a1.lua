...
SWEP.Description = [[The M4 is the carbine variant of the AR-15 adopted by the United States Military, derived from the M16 assault rifle adopted by the United States.]]


SWEP.UseHands = true -- Same as weapon_base

SWEP.ViewModel = "models/weapons/arc9_m9k_m4a1.mdl"
...
SWEP.RangeMax = 6500-- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.RecoilUp = 0.80 -- Multiplier for vertical recoil
...
SWEP.ShootSound = "weapons/m4a1/shoot.wav"                          -- Fire
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Category = {"m9k_tacb"},
        Bone = "weapon",
        Pos = Vector(0, -1.2, 12.9),
        Ang = Angle(90, 0, 90),
        
    },
    {
        PrintName = "Sticker A",
        StickerModel = "models/stickers/arc9_m9k_stickersa_m4a1.mdl",
        Category = "stickers",
        Bone = "weapon",
        Pos = Vector(0, 0, 0),
    },
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
            {s = "weapons/m4a1/magout.mp3", t = 0.40},
            {s = "weapons/m4a1/magin.mp3", t = 1.15},
            {hide = 1, t = 0.50},
            {hide = 0, t = 0.95},
        }
    },
    ["reload_empty"] = {
        ...
        EventTable = {
            {s = "weapons/m4a1/magout.mp3", t = 0.40},
            {s = "weapons/m4a1/magin.mp3", t = 1.15},
            {s = "weapons/m4a1/boltrelease.mp3", t = 1.895},
            {hide = 1, t = 0.50},
            {hide = 0, t = 0.95},
        }
    },
