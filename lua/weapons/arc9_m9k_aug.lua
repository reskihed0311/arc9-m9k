...
SWEP.ViewModel = "models/weapons/arc9_m9k_auga3.mdl"
...
SWEP.Distance = 20000 -- In Hammer units, how far bullets can travel, period.
...
SWEP.Attachments = {
    ...
    {
        PrintName = "Sticker A",
        StickerModel = "models/stickers/arc9_m9k_stickersa_auga3.mdl",
        Category = "stickers",
        Bone = "weapon",
        Pos = Vector(0, 0, 0),
    },
...
SWEP.Animations = {
    ...
    ["reload"] = {
        Source = "reload",
        EventTable = {
            {s = "weapons/aug/clipout.mp3", t = 0.43},
            {s = "weapons/aug/clipin.mp3", t = 1.55},
            {hide = 1, t = 0.43},
            {hide = 0, t = 1.20},
        }
    },
    ["reload_empty"] = {
        ...
        EventTable = {
            {s = "weapons/aug/clipout.mp3", t = 0.43},
            {s = "weapons/aug/clipin.mp3", t = 1.55},
            {s = "weapons/aug/boltback.wav", t = 2.10},
            {s = "weapons/aug/boltfwd.wav", t = 2.23},
            {hide = 1, t = 0.43},
            {hide = 0, t = 1.20},
        }
    },
