...
SWEP.ViewModel = "models/weapons/arc9_m9k_amd65.mdl"
...
SWEP.WorldModelOffset = {
     Pos = Vector(-8, 5, -4.5), -- non tpik (while on ground, on npc etc)
     Ang = Angle(0, 0, 180),
     TPIKPos = Vector(-8, 5, -4.5), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.DropMagazineModel = "models/mags/m9k_mag_amd65.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.ShootSound = "weapons/amd65/amd-1.wav"                           -- Fire

SWEP.ShootSoundSilenced = "weapons/supp_library/762rus_fire.wav"                 -- Fire silenced
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
            {s = "weapons/amd65/clipout.mp3", t = 0.70},
            {s = "weapons/amd65/magin2.mp3", t = 1.35},
            {hide = 0, t = 0.43},
            {hide = 1, t = 1.1},
        }
    },
    ["reload_empty"] = {
        ...
        EventTable = {
            {s = "weapons/amd65/clipout.mp3", t = 0.70},
            {s = "weapons/amd65/magin2.mp3", t = 1.35},
            {s = "weapons/amd65/boltpull.mp3", t = 2},
            {s = "weapons/amd65/boltrelease.mp3", t = 2.18},
            {hide = 0, t = 0.43},
            {hide = 1, t = 1.1},
        }
    },
