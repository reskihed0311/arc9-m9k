...
SWEP.RangeMax = 750-- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.Attachments = {
    ...
    {
        PrintName = "Sticker A",
        StickerModel = "models/stickers/arc9_m9k_stickersa_browningauto5.mdl",
        Category = "stickers",
        Bone = "weapon",
        Pos = Vector(0, 0, 0),
    },
...
SWEP.Animations = {
    ...
    ["reload_start"] = {
        Source = "reload_start",
        EventTable = {
            {s = "weapons/ba5/xm1014_deploy.mp3", t = 0},
            {hide = 1 , t = 0},
        }
    },
    ["reload_insert"] = {
        Source = "reload_loop",
        EventTable = {
            {s = "weapons/ba5/xm1014_insertshell.mp3", t = 0.20},
   ...
   {s = "weapons/ba5/xm1014_insertshell.mp3", t = 0.5},
   {s = "weapons/ba5/boltfwd.wav", t = 1.1},
            {hide = 1 , t = 0},
        }
    },
    ["draw"] = {
