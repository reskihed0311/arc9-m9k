...
SWEP.Description = [[The Heckler & Koch MP5 (Maschinenpistole 5, lit. "submachine gun 5") is a highly-successful German submachine gun designed by Tilo Möller, Manfred Guhring, Georg Seidl, Helmut Baureuter, Rudolf Brandl, Herbert Doll, Paul Thevis, Helmut Danner and Erich Weisser in 1964 and manufactured by Heckler & Koch since 1966.
 Having been adopted by some 40 nations, the MP5 is one of most widely used submachine guns in the world.
  A successor weapon, the UMP was also developed, but has not shared the same level of success.]]


SWEP.UseHands = true -- Same as weapon_base

SWEP.ViewModel = "models/weapons/arc9_m9k_mp5a1.mdl"
...
SWEP.WorldModelOffset = {
     Pos = Vector(-8.9, 4, -3), -- non tpik (while on ground, on npc etc)
     Ang = Angle(0, 0, 180),
     TPIKPos = Vector(-8.9, 5, -3), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.Distance = 5500 -- In Hammer units, how far bullets can travel, period.
...
--[[SWEP.DropMagazineModel = "models/mags/m9k_mag_kacpdw.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.SpreadAddSighted = 0.004 -- Applied when sighted. Can be negative.
...
SWEP.ShootSound = "weapons/mp5/mp5-1.wav"                         -- Fire

SWEP.ShootSoundSilenced = "weapons/supp_library/9mmpistol.wav"                    -- Fire silenced
...
SWEP.Attachments = {
    ...
    {
        PrintName = "Sticker A",
        StickerModel = "models/stickers/arc9_m9k_stickersa_mp5a4.mdl",
        Category = "stickers",
        Bone = "weapon",
        Pos = Vector(0, 0, 0),
    },
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
            {s = "weapons/mp5/magout.mp3", t = 0.25},
            {s = "weapons/mp5/magin2.mp3", t = 1.35},
            {hide = 1, t = 0.5},
            {hide = 0, t = 0.9},
        }
    },
    ["reload_empty"] = {
        ...
        EventTable = {
            {s = "weapons/mp5/boltback.mp3", t = 0.25},
            {s = "weapons/mp5/magout.mp3", t = 0.90},
            {s = "weapons/mp5/magin2.mp3", t = 1.90},
            {s = "weapons/mp5/boltslap.mp3", t = 2.40},
            {hide = 1, t = 1},
            {hide = 0, t = 1.5},
        }
    },
