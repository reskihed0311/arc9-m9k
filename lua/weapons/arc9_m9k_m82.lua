...
SWEP.ViewModel = "models/weapons/arc9_m9k_m82.mdl"
...
SWEP.WorldModelOffset = {
     Pos = Vector(-5,5, -5), -- non tpik (while on ground, on npc etc)
     Ang = Angle(0, 0, 180),
...
SWEP.SprintToFireTime = 0.50 -- How long it takes to go from sprinting to being able to fire.
...
SWEP.ShootSound = "weapons/m82/barret50-1.wav"                            -- Fire
...
SWEP.Animations = {
    ...
    ["reload"] = {
        Source = "reload",
        EventTable = {
            {s = "weapons/m82/clipout.mp3", t = 1.1},
            {s = "weapons/m82/clipin.mp3", t = 2.41},
            {hide = 1, t = 1.5},
            {hide = 0, t = 2.1},
        }
    },
    ["reload_empty"] = {
        ...
        EventTable = {
            {s = "weapons/m82/clipout.mp3", t = 1.1},
            {s = "weapons/m82/clipin.mp3", t = 2.41},
            {s = "weapons/m82/boltup.mp3", t = 3.39},
            {s = "weapons/m82/boltdown.mp3", t = 3.68},
            {hide = 1, t = 1.5},
            {hide = 0, t = 2.1},
        }
    },
