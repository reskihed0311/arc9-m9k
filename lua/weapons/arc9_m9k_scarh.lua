...
SWEP.Description = [[The KAC PDW was a prototype PDW designed by KAC, that was first presented on the NDIA Small Arms Symposium in 2006.]]


SWEP.UseHands = true -- Same as weapon_base

SWEP.ViewModel = "models/weapons/arc9_m9k_scarh.mdl"
...
SWEP.ShootSound = "weapons/scarh/aug-1.wav"                         -- Fire

SWEP.ShootSoundSilenced = "weapons/supp_library/556_fire.wav"                    -- Fire silenced
...
SWEP.ShellPitch = 90 -- for shell sounds
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
            {s = "weapons/scarh/aug_clipout.mp3", t = 0.40},
			{s = "weapons/scarh/aug_clipin.mp3", t = 1.48},
			{s = "weapons/scarh/aug_boltslap.mp3", t = 1.90},
        }
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        ...
        EventTable = {
			...
			{s = "weapons/scarh/aug_clipin.mp3", t = 1.48},
			{s = "weapons/scarh/aug_boltslap.mp3", t = 1.90},
			{s = "weapons/scarh/aug_boltpull.mp3", t = 2.3},
        }
    },
    ["draw"] = {
        Source = "draw",
