...
SWEP.Description = [[TThe Barrett M82, informally known as the Light Fifty or the Barrett .50 cal, is a high-powered special applications scoped rifle developed by the American Barrett Firearms Company.
 It is chambered in the .50 BMG cartridge. 
 This was the first gun to put the .50 BMG cartridge in a shoulder-fired rifle that could be operated by a single individual.]]


SWEP.UseHands = true -- Same as weapon_base

SWEP.ViewModel = "models/weapons/arc9_m9k_1887.mdl"
...
SWEP.WorldModelOffset = {
     Pos = Vector(-10,4, -5), -- non tpik (while on ground, on npc etc)
     Ang = Angle(0, 0, 180),
     TPIKPos = Vector(-10,4, -5), -- arc9_tpik 1, you can make cool poses with it
...
-- range for 12 gauge , but slow reloading
...
SWEP.Distance = 1700-- In Hammer units, how far bullets can travel, period.
...
SWEP.ShootSound = "weapons/1887/fire2.wav"                            -- Fire
...
SWEP.ActivePos = Vector(-0.15, -3, 0)
...
SWEP.Attachments = {
    ...
    {
        PrintName = "Sticker A",
        StickerModel = "models/stickers/arc9_m9k_stickersa_1887.mdl",
        Category = "stickers",
        Bone = "weapon",
        Pos = Vector(0, 0, 0),
    },
...
SWEP.Animations = {
    ...
    ["cycle"] = {
        ...
        EjectAt = 0.3,
        EventTable = {
            {s = "weapons/1887/1887pump1.mp3", t = 0.21},
            {s = "weapons/1887/1887pump2.mp3", t = 0.61},
            {hide = 1 , t = 0},
        }
    },
    ["reload_start"] = {
        Source = "reload_start",
        EventTable = {
            {s = "weapons/1887/1887pump1.mp3", t = 0.2},
            {hide = 1 , t = 0},
        }
    },
    ["reload_insert"] = {
        Source = "reload_loop",
        EventTable = {
            {s = "weapons/1887/1887_insertshell.mp3", t = 0.2},
            {hide = 0 , t = 0},
        }
    },
    ["reload_finish"] = {
        Source = "reload_end",
        EventTable = {
            {s = "weapons/1887/1887pump2.mp3", t = 0.25},
            {hide = 1 , t = 0},
        }
    },
    ["draw"] = {
