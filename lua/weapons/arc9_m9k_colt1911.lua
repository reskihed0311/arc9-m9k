...
SWEP.Description = [[The M1911 (often referred to simply as 1911) is a single action short recoil-operated semi-automatic pistol, chambered in .45 ACP.
  It features a 7 round magazine and has an effective range of approximately 50 meters. 
  Its name sake derives from the year it was first produced, in 1911.]]


SWEP.UseHands = true -- Same as weapon_base

SWEP.ViewModel = "models/weapons/arc9_m9k_1911.mdl"
...
SWEP.Attachments = {
    ...
    {
        PrintName = "Sticker A",
        StickerModel = "models/stickers/arc9_m9k_stickersa_1911.mdl",
        Category = "stickers",
        Bone = "weapon",
        Pos = Vector(0, 0, 0),
    },
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
            {s = "weapons/1911/de_clipout.mp3", t = 0.35},
            {s = "weapons/1911/de_clipin.mp3", t = 1.1},
            {hide = 1, t = 0.35},
            {hide = 0, t = 0.9},
        }
    },
    ["reload_empty"] = {
        ...
        EventTable = {
            {s = "weapons/1911/de_clipout.mp3", t = 0.35},
            {s = "weapons/1911/de_clipin.mp3", t = 1.1},
            {s = "weapons/1911/de_slideback.mp3", t = 1.55},
            {hide = 1, t = 0.35},
            {hide = 0, t = 0.9},
        }
    },
